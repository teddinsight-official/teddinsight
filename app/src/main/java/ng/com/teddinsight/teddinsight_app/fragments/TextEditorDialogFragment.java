...
import ng.com.teddinsight.teddinsight_app.adapter.FontPickerAdapter;
...
public class TextEditorDialogFragment extends DialogFragment {
    ...
    //Show dialog with provide text, text color and text font
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        LinearLayoutManager fontLayoutManager = new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, false);
        ...
        mAddTextDoneTextView.setOnClickListener(view1 -> {
            ...
            if (!TextUtils.isEmpty(inputText) && mTextEditor != null) {
                mTextEditor.onDone(inputText, mColorCode, mTypeface);
            }
        });
